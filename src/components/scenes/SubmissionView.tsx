  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-6 text-center">
      ...
      <div className="grid grid-cols-3 gap-6 max-w-md mb-8">
        ...
        <div className="bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-lg p-4">
          <svg className="w-5 h-5 text-cyan-400 mx-auto mb-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="flex gap-4">
        ...
        <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white py-2 px-4 rounded-lg flex items-center transition-all">
          Next Problem
