                    ...
                    <header className="fixed top-0 left-0 right-0 p-6 z-50">
                        <div className="max-w-7xl mx-auto flex justify-between items-center">
                            <div className="flex items-center gap-2">
                                <div className="text-accent font-bold text-2xl">LeetStart</div>
                            </div>
                            <nav>
                                <ul className="flex gap-6">
                                    <li><Link to="problems" className="text-gray-200 hover:text-white transition-colors">Problems</Link></li>
                            ...
                            <div>
                                <Link to="/login" className="bg-accent hover:bg-cyan-600 text-white py-2 px-4 rounded-lg font-medium transition-colors">
                                    Sign In
                                </Link>
                            </div>
                        </div>
